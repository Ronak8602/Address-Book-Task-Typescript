...
import { Contact } from "./api_provider.js";

function validate(name: string, email: string, mobile: string, landline: string, website: string) : boolean {
...
function toggleAddDialogue() : void {
...
function toggleUpdateDialogue() : void {
    document.querySelector("#addContactDialog")!.classList.toggle("show2");
    document.querySelector("#updateContactButton")!.classList.toggle("showButton");
    setValidators();
}
...
function addContact(): void {
    ...
    if (isCorrect) {
        ...
        let dataArray: Array<Contact> = ApiProvider.getFromLocalStorage("users")!;
...
function createNewContactDiv(index: string, data: Contact) : void{
...
function showContactDetails(id: string) : void{
    ...
    let userList: Array<Contact> = ApiProvider.getFromLocalStorage("users");
...
function openUpdateContactDialog(id: string) : void{
    selectedIndex = id;
    let userList: Array<Contact> = ApiProvider.getFromLocalStorage("users");
...
function createContactNode(id: string, name: string, email: string, mobile: string) : HTMLDivElement {
...
function addEventListenerOnContactCards(): void {
    let userList: Array<Contact> = ApiProvider.getFromLocalStorage("users")!;
...
function checkEmptyMessage(): void {
...
document.addEventListener("DOMContentLoaded", () => {
    let apiProvider: ApiProvider = new ApiProvider();
